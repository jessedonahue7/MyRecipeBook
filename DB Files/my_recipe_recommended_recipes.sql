...
--
-- Host: localhost    Database: my_recipe
-- ------------------------------------------------------
...
CREATE TABLE `recommended_recipes` (
  ...
  PRIMARY KEY (`recipeID`,`emaill`),
  KEY `recipeID_idx` (`recipeID`),
  KEY `emaill_C` (`emaill`),
  CONSTRAINT `emaill_C` FOREIGN KEY (`emaill`) REFERENCES `users` (`emaill`),
  CONSTRAINT `recipeID_C` FOREIGN KEY (`recipeID`) REFERENCES `recipes` (`recipeID`)
...
-- Dump completed on 2020-10-07 15:39:21
